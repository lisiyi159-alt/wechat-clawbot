...
window.DASHBOARD = {
  ...
  ipoQueue: {
    // 港股 IPO 市场整体概览（2026 上半年，来源：瑞恩资本 RyanBen Capital）
    market: {
      period: "2026 上半年",
      source: "瑞恩资本 RyanBen Capital",
      stats: [
        { label: "新上市家数", value: "87", sub: "同比 +97.7%（+43 家）" },
        { label: "IPO 募资", value: "2,101.95 亿", sub: "港元 · +92.1% · 均 24.93 亿/家" },
        { label: "上市公司总数", value: "2,748", sub: "主板 2,443 / GEM 305" },
        { label: "总市值", value: "433,245 亿", sub: "港元 · 同比 -9.1%" },
      ],
      note:
        "结构：主板 IPO 83 + 介绍 1 + GEM 转主板 2、GEM IPO 1（合计 87，其中 IPO 84）。" +
        "上半年新上市数已超 2024 全年（71 家、879.75 亿）与 2023 全年（73 家、463.21 亿），大型科技与 A 股公司带动；" +
        "前 5 月 62 只新股中 20 只翻倍、10 只市值超千亿（智谱涨 12 倍、深演智能涨 7 倍、MiniMax 涨 4 倍）。",
    },
    // 2026 上半年医疗健康新股（自瑞恩「87 家新股全名单」中筛选，募资额单位：亿港元）
    // 注：按原图整理，公司名/代码如有 OCR 误差请对照原文校正。
    newListingsMed: {
      title: "2026 上半年医疗健康新股（部分）",
      source: "瑞恩资本 · 募资额（亿港元）",
      note: "自「上半年 87 家新股全名单」中筛选医疗健康标的；按原图整理，名称/代码请对照瑞恩原文校正。",
      items: [
        { name: "缔造医疗-B", code: "02675.HK", region: "广东深圳", date: "2026-01-08", funds: 13.79 },
        { name: "天辰生物-B", code: "01779.HK", region: "广东深圳", date: "2026-05-15", funds: 13.63 },
        { name: "迈威生物-B", code: "02493.HK", region: "上海", date: "2026-04-16", funds: 12.88 },
        { name: "礼邦医药-B", code: "09637.HK", region: "江苏扬州", date: "2026-05-13", funds: 12.65 },
        { name: "华健未来-B", code: "06132.HK", region: "四川成都", date: "2026-06-24", funds: 11.12 },
        { name: "可孚医疗", code: "01187.HK", region: "湖南长沙", date: "2026-05-06", funds: 10.67 },
        { name: "英派药业-B", code: "07630.HK", region: "江苏南京", date: "2026-05-13", funds: 9.09 },
        { name: "天星医疗", code: "01609.HK", region: "北京", date: "2026-03-30", funds: 8.30 },
        { name: "丹诺医药-B", code: "06872.HK", region: "江苏苏州", date: "2026-04-16", funds: 6.70 },
        { name: "真健康医疗-B", code: "02697.HK", region: "广东深圳", date: "2026-06-24", funds: 4.50 },
      ],
    },
    summary:
  ...
  hotspots: [
    ...
    { title: "港股医疗 IPO 大年", tag: "医疗", desc: "约 91 家医疗保健排队，上半年 10 家生物医药登陆港交所。", trend: "up" },
    { title: "港股 IPO 市场回暖", tag: "科技", desc: "上半年上市 87 家、募资 2,101.95 亿港元，同比近翻倍，大型科技与 A 股公司带动。", trend: "up" },
